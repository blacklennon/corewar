...
//void		op_ldi(t_process *process, t_args *args, t_vm *vm);
//void		op_sti(t_process *process, t_args *args, t_vm *vm);
//void		op_fork(t_process *process, t_args *args, t_vm *vm);
//void		op_lld(t_process *process, t_args *args, t_vm *vm);
//void		op_lldi(t_process *process, t_args *args, t_vm *vm);
//void		op_lfork(t_process *process, t_args *args, t_vm *vm);
